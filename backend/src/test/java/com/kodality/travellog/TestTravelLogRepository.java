...
public class TestTravelLogRepository {

    private final JdbcTemplate jdbcTemplate;

    public TestTravelLogRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public int create(TravelLog e){
        String query="INSERT INTO travellogs_test VALUES( '"
                +e.getId()+"','"
                +e.getDate()+"','"
    ...
    public int update(TravelLog e){
        String query="UPDATE travellogs_test SET " +
    ...
    public int destroy(String id){
        String query="DELETE FROM travellogs_test WHERE id='"+id+"'";
        return jdbcTemplate.update(query);
    }

    public List<TravelLog> all() {
        String query="SELECT * FROM travellogs_test";
    ...
    public TravelLog find(String id) {
        String query="SELECT * FROM travellogs_test WHERE id= ?";
        try {
    ...
    public List<TravelLog> where(String paramName, String param) {
        String query = "SELECT * FROM travellogs_test WHERE "+ paramName + "='"+param+"'";
    ...
    public List<TravelLog> whereDate(String beginDate, String endDate) {
        String query = "SELECT * FROM travellogs_test WHERE " +
